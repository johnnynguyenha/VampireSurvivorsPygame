...
class Player(pygame.sprite.Sprite):
    ...
    def load_images(self):
        ...
        # put all left sprite paths into the left dictionary, put all right sprite paths into right dictionary, etc.
    ...
    def move(self, dt):
        self.hitbox_rect.x += self.direction.x * self.velocity * dt
